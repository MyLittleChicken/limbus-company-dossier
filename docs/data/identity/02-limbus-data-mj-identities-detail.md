...
> **정정 2026-07-30 (회차 7).** 최소 2건은 누락이 아니라 **삭제**다. `shared-library` 구버전에
> `1071205`(흑운회 와카슈, 공격) · `1021207`(흑수-묘 필두, 방어)이 있었고 현행에서 사라졌다.
> mj는 여전히 갖고 있다. 나머지 10건도 삭제인지 누락인지는 회차 10에서 확인한다.
